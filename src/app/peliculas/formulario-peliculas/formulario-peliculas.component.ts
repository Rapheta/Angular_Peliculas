...
@Component({
  ...
  standalone: true,
  imports: [MatFormFieldModule, ReactiveFormsModule, MatInputModule, RouterLink, MatDatepickerModule, InputImgComponent, MatButtonModule, SelectorMultipleComponent, AutocompleteActoresComponent],
